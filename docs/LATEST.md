...
🔴 1. 5월 20일 공모 응모서 작성 (D-5, 풀타임 집중, 본인 직접)
🟡 2. at_global 위젯 정렬 fix (30분~1시간, 다음 세션)
🟢 3. cron 자동 실행 모니터링 (매일 아침 5분)
🟢 4. 7월 3일 공모 응모서 (6월 본격 시작)
🟢 5. (보류) 백로그 035 표준 포맷, 백로그 031 정리 등 — 공모 두 개 후 진행
